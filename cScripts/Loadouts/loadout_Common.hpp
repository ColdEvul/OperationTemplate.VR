...
class C_G {                // "G"         | GRENADIER
    ...
    vest            = _GEAR_VEST_GRENADER;
    headgear        = _GEAR_HELMET0;
    goggles         = _GEAR_GOOGLES;
...
class C_M {                  // "M"         | COMBAT LIFESAVER
    ...
    magazines[] = {};
    addItemsToUniform[] = {
        _QUA5(_MED_PACKINGBANDAGE),
        _QUA5(_MED_ELASTICBANDAGE),
        _QUA2(_MED_MORPHINE),
        _QUA2(_MED_EPINEPHRINE),
        _QUA1(_MED_TOURNIQUET),
    ...
    addItemsToBackpack[] = {
        ...
        _QUA2(_CHEMLIGHT_BLUE),
        _QUA2(_CHEMLIGHT_RED),	
        _QUA10(_MED_PACKINGBANDAGE),
        _QUA10(_MED_ELASTICBANDAGE),	
        _QUA10(_MED_FIELDDRESSING),
        _QUA10(_MED_QUIKCLOT),	
        _QUA2(_MED_SAL1),
        _QUA2(_MED_SAL500)				
    };
...
class C_MOG {           // "MOG"       | MORTAR GUNNER
    uniform         = _GEAR_UNIFORM0;
    vest            = _GEAR_VEST_ENGINEER;
    headgear        = _GEAR_HELMET0;
    goggles         = _GEAR_GOOGLES;
    nvgoggles       = _ITEM_NIGHTVISION0;
    backpack        = _GEAR_BACKPACK_MORTAR0;
...
class C_ENG {               // "ENG"       | ENGINEER
    ...
    addItemsToBackpack[] = {	
        _QUA5(_CHEMLIGHT_BLUE),
        _QUA5(_CHEMLIGHT_RED),	
        _QUA1(_ITEM_TOOLKIT),
        _QUA1(_ITEM_DETONATOR),	
        _QUA1(_ITEM_DEFUSALKIT),	
        _QUA1(_MAG_DEMOCHARGE)					
    };
...
class C_JTAC {             // "JTAC"      | JTAC
    ...
    goggles         = _GEAR_GOOGLES;
    nvgoggles       = _ITEM_NIGHTVISION0;
    backpack        = _GEAR_BACKPACK_RADIO0;
...
class C_FM {        // "FM"        | FLIGHT MEDIC OR PLATOON MEDIC
    ...
    addItemsToVest[] = {
        ...
        _QUA2(_GRENADE),	
        _QUA4(_GRENADE_SMOKE),	
        _QUA1(_MED_SURGICALKIT),	
        _QUA5(_MED_PERSONALAIDKIT)							
    };
    addItemsToBackpack[] = {
        _QUA4(_MAG_PRIMARY),
        _QUA2(_GRENADE),	
        ...
        _QUA2(_CHEMLIGHT_BLUE),
        _QUA2(_CHEMLIGHT_RED),
        _QUA15(_MED_MORPHINE),
        _QUA15(_MED_EPINEPHRINE),	
        _QUA25(_MED_PACKINGBANDAGE),
        _QUA25(_MED_ELASTICBANDAGE),	
        _QUA25(_MED_FIELDDRESSING),
        _QUA25(_MED_QUIKCLOT),	
        _QUA4(_MED_SAL1),
        _QUA2(_MED_SAL500)				
    };
