...
class C_SPT {                // "SPT"       | SPOTTER
    ...
    primaryWeapon   = _WEAPON_PRIMARY1;
...
class C_SNP {                 // "SNP"       | SNIPER
    ...
    primaryWeapon   = _WEAPON_SNIPER0;
    primaryWeaponAttachments[] = {
        _WEAPON_ATTACHMENT0,
        _WEAPON_ATTACHMENT1,
        _WEAPON_ATTACHMENT_SCOPE1
    };
